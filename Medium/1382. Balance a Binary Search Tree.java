...
class Solution {
    public TreeNode balanceBST(TreeNode root) {
        // Create a list to store the inorder Traversal of the Binary Search Tree (BST)
    ...
    private void inorderTraversal(TreeNode root, List<Integer> inorder) {
        // Perform an inorder traversal to store the elements in stored order
        if (root == null) return;
    ...
    private TreeNode createBalancedBST(
        ...
        // Base caes: if the start index is greater than the end index, return null
